...
**Always prefer using the website** for viewing and uploading files

⚠️ **As of August 2026 users can only contribute and view through the [Website](https://iiserm.github.io/question-paper-repo/)** ⚠️
...
#### For Website issues please open an Issue here:
[Open an Issue](https://github.com/IISERM/question-paper-repo/issues/new)

#### For Materials related issue:
- Broken links/files, unreadable scans, or wrong metadata
- Takedown requests (with justification)

Please reach out to us through email: turingclub@iisermohali.ac.in
...
| 🥈 | Jasmeen Kaur | 122 |
| 🥉 | BALAKUMARAN S | 111 |
| 4 | HARSH VARDHAN SHRESHTH | 99 |
| 5 | SASHVATH KRISHNAN S | 70 |

*Last updated: 2026-09-08 05:41:23 UTC*
